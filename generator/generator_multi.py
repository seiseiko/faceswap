...
@LastEditTime: 2020-06-04 11:12:46
...
class GeneratorMulti(PipelineBase):
    class Worker(Generator, PipelineBase.Worker):
        ...
        def _process(self, work_func):
            ...
            Generator.__init__(self, model_class_name=self.model_class_name, saved_models_path=self.saved_models_path,
            ...
            while True:
                if not self.s2c.empty():
                    ...
                    try:
                        ...
                        self.c2s.put(data.frame)
                else:
                    time.sleep(0.001)

    def __init__(self, model_class_name="SAEHD", saved_models_path="./checkpoint/model",
    ...
    def on_initialize(self):
        self.worker_cls = GeneratorMulti.Worker
